        ...
        <section id="aboutMe" className="about-me">
            ...
            <div className="about-me__cells">
                <div className="about-me__text-cells">
                    ...
                    <h4 className="about-me__subtitle">{constants.aboutMe.subtitle}</h4>
                    <p className="about-me__description">{constants.aboutMe.description}</p>
                </div>
                <img src={constants.aboutMe.photo} className="about-me__photo-cell" alt="мое фото" />
            </div>
            <nav className="about-me__menu">
                <h3 className="about-me__menu-title">{constants.aboutMe.navBarTitle}</h3>
                <ul className="about-me__menu-items">
                    {constants.aboutMe.navBar.map(ref => {
                        return (
                            <li key={ref.title} className="about-me__menu-item">
                                <a href={ref.link} className="about-me__item-link" target="blank" alt={ref.title}>
